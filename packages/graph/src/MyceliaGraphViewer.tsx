...
import type { GraphViewerProps, GraphNode, GraphLink, GraphData } from './types'
import type { ComponentType } from 'react'
import { Suspense, lazy } from 'react'

// Lazy load ForceGraph2D to avoid SSR issues - properly typed
...
export function MyceliaGraphViewer({ 
  ...
  if (loading) {
    return (
      <div className={`max-w-7xl mx-auto py-8 px-6 ${className}`}>
